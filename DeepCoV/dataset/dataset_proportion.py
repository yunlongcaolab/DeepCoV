...
class SARS2SpikeProteinDataset_EvoData(Dataset):
    """Dataset for SARS-CoV-2 spike protein with evolution and DMS data.
    
    Integrates sequence data, DMS measurements, and evolution counts for
    training SARS-CoV-2 variant proportion prediction models.
    """
