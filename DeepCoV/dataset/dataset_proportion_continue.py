...
class SARS2SpikeProteinDataset_EvoData(Dataset):
    """Dataset for continuous time series prediction.
    
    Specialized dataset for continuous prediction across time points,
    focusing on temporal evolution patterns in SARS-CoV-2 data.
    """
