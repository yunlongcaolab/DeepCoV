...
class SARS2SpikeProteinDataset_EvoData_V6_rbd(Dataset):
    """RBD-specific dataset for continuous time series prediction.
    
    Specialized dataset for RBD region with continuous prediction capabilities
    across multiple time points in evolution data.
    """
