...
class _DMS(object):
    """Internal DMS data handler.
    
    Core class for managing deep mutational scanning data including
    mutant validation and sequence alignment processing.
    """
...
class DMSReader(object):
    """Reader for DMS feature queries.
    
    Provides interface for querying DMS features based on
    sequence input and base feature specifications.
    """
...
class DMSAccessor(object):
    """High-level DMS data accessor.
    
    Provides unified access to DMS features with clustering support
    and time-delayed data integration for evolution analysis.
    """
