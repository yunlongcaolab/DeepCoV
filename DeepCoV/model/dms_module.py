...
class dms_class_weight_landsape(nn.Module):
    """Learnable class-weighted DMS landscape.
    
    Computes weighted combination of DMS landscapes using
...
class DMSLayer(nn.Module):
    """Core DMS feature processing layer.
    
    Integrates sequence embeddings with DMS measurements
    for mutational effect prediction and analysis.
    """
