...
from dataset.dataset_proportion import SARS2SpikeProteinDataset_EvoData as SARS2SpikeProteinDataset
    ...
    with torch.no_grad():
        ...
        if rank == 0:
            ...
            mse=log_metrics_eval(config,
                                ...
                                val_dataset,
                                status)
        print(f"Rank2 {rank} reached barrier")
        dist.barrier()
        print(f"Rank2 {rank} passed barrier") 
        if rank == 0:
            return mse
        else:
            return None
...
if __name__ == "__main__":
    ...
    parser.add_argument('--mode',  type=str,default ='run_train / run_validationsss')
