...
## Overview
This repository contains the codebase, data, and analysis pipelines for DeepCoV, a framework designed for forecasting the prevalence and evolution of SARS-CoV-2 variants. It integrates evolutionary sequences, mutational scanning, and epidemiological modeling to analyze dominant variants, predict mutational hotspots, and evaluate variant dynamics.
...
│   ├── results
├── benchmark # benchmarking DeepCoV against other models (e.g., EVEscape, E2VD)
│   ├── analysis
│   ├── DMS
│   │   └── fitting
│   ├── dynamic_topk_calc.R
...
3. all accessible gisaid ids download through GisaidR
...
the preprocessed data could be downloaded from zenodo.
...
examples:
```
conda actiavte r_deepcov_analysis
Rscript benchmark/timeline.R # fig.2c
Rscript spatiotemporal_evaluation/growth_trajectory_reconstruction.R # fig.3a
```
