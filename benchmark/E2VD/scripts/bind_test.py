...
if __name__ == '__main__':
    ...
    model_dir="/lustre/grp/cyllab/yangsj/evo_pred/1article/benchmark/E2VD/model/bind/result_32_a0.9_lr2e-05_regk1_k5_f1_prop_/model_{}.pth.tar"
    ...
    if 1:
        # load train data
        train_feats=np.load(f'{ori_data_embedding_dir}/single_bind_esm2_train_data.npy')
        ...
        # load test data
        test_feats=np.load(f'{test_data_embedding_dir}/single_bind_esm2_test_data.npy')
        test_reg_label=np.load(f'{test_data_embedding_dir}/single_bind_esm2_test_label.npy')
    ...
    with torch.no_grad():
        for model_i in range(model_n):
            ...
            df.to_csv(f'{res_dir}/E2VD_bind_output_test_JN1era_fold{model_i}.csv',index=False)
