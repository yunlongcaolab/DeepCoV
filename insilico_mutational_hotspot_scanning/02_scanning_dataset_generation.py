...
# # base_strain='LP.8'
# base_strain='XFG'
# dates = pd.date_range('2025-03-01', '2025-04-15') 
...
date_tag = '241030'
base_strain='JN.1'
# dates = pd.date_range('2024-01-17', '2024-01-17')
dates = pd.date_range('2023-11-17', '2023-11-17')
...
# base_strain='EG.5'
# # dates = pd.date_range('2023-07-25', '2023-08-01')
# dates = pd.date_range('2023-03-07', '2023-03-07')

# date_tag = '241030'
# base_strain='XBB'
# dates = pd.date_range('2022-09-01', '2022-09-02')

# date_tag = '241030'
# base_strain='XBB.1.5'
# dates = pd.date_range('2022-12-30', '2022-12-30')
