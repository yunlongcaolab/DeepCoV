...
### LF.7 scanning for newest XFG
# data_dir = '/lustre/grp/cyllab/yangsj/evo_pred/0article'
# save_dir = str_glue('{data_dir}/insilico_mutational_hotspot_scanning/results/rbd_single_JN1era_update_LF7mutscan_new')
# res = read_csv(str_glue('{data_dir}/insilico_mutational_hotspot_scanning/results/rbd_single_JN1era_update_LF7mutscan_new/LF7-2025-03-01to2025-04-15_regres_outputs_labels-step-36410.csv'))
# base_strain = 'LF.7'
# postfix = ''
# location = 'Global'
# site_show_normal = c(445,487,493)
# min_thres = 0.00
# nshow_site = 10 # logoplot

# data_dir = '/lustre/grp/cyllab/yangsj/evo_pred/0article'
# save_dir = str_glue('{data_dir}/insilico_mutational_hotspot_scanning/results/rbd_single_JN1era_update_LP8mutscan_new')
# res = read_csv(str_glue('{data_dir}/insilico_mutational_hotspot_scanning/results/rbd_single_JN1era_update_LP8mutscan_new/LP8-2025-03-01to2025-04-15_regres_outputs_labels-step-36410.csv'))
# base_strain = 'LP.8'
# postfix = ''
# location = 'Global'
# site_show_normal = c(444,487,512)
# min_thres = 0.00
# nshow_site = 10 
