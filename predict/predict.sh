...
#SBATCH --output=predict/log/rbd_JN1era-%j.out        
#SBATCH --error=predict/log/rbd_JN1era-%j.err           
...
RUN_NAME=rbd_single_JN1era_revis
...
torchrun --nnodes $NNODES \
    ...
    DeepCoV/main_proportion_predict.py --run_name $RUN_NAME --mode $MODE --config $CONFIG
